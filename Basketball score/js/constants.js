...
const homeBtns = homePannel.querySelectorAll('button');
const guestBtns = guestPannel.querySelectorAll('button');

const resetHome = homeNode.querySelector('.reset');
const resetGuest = guestNode.querySelector('.reset');